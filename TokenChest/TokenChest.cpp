...
namespace itemcodes {
	std::vector<ItemCode> itemcodes = {
		...
		{"Annihilus", "Misc", "Prime Charm", "aby1", 0},
		{"Annihilus", "Misc", "Prime Charm", "aby2", 0},
		{"Annihilus", "Misc", "Prime Charm", "aby3", 0},
		{"Annihilus", "Misc", "Prime Charm", "aby4", 0},
		{"Annihilus", "Misc", "Prime Charm", "aby5", 0},
		{"Annihilus", "Misc", "Prime Charm", "aby6", 0},
		{"Annihilus", "Misc", "Prime Charm", "aby7", 0},
		{"Annihilus", "Misc", "Prime Charm", "aby8", 0},
		{"Annihilus", "Misc", "Large Charm", "aby9", 0},
...
BOOL CALLBACK FinderDialogProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	switch (message) {
		case WM_INITDIALOG:	{
			...
			g_TAB.addTab("TokenHack", CreateDialog(g_hInst, MAKEINTRESOURCE(IDD_TABPAGE4), g_TAB.getParent(), TabPage4Proc));
			g_TAB.selectTab(0);
...
BOOL CALLBACK TabPage4Proc(HWND hwnd, UINT message, WPARAM /*wParam*/, LPARAM lParam) {
	switch (message) {
		case WM_INITDIALOG:{
