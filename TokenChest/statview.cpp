...
//	COLORREF gray = RGB(80, 80, 80);
	...
	vector<pair<int, COLORREF>> ids = {
		{STAT_DAMAGE_REDUCE_PERCENT, white},
		{STAT_MAGIC_RESIST, orange},
		{STAT_FIRE_RESIST, red},
		{STAT_COLD_RESIST, blue},
		{STAT_LIGHTNING_RESIST, yellow},
		{STAT_POISON_RESIST, green},
		{STAT_MAX_MAGIC_RESIST, orange},
		{STAT_MAX_FIRE_RESIST, red},
		{STAT_MAX_COLD_RESIST, blue},
		{STAT_MAX_LIGHTNING_RESIST, yellow},
		{STAT_MAX_POISON_RESIST, green},
		{STAT_DAMAGE_REDUCE, white},
		{STAT_MAGIC_DAMAGE_REDUCE, white},
		{STAT_FIRE_ABSORB_PERCENT, red},
		{STAT_COLD_ABSORB_PERCENT, blue},
		{STAT_LIGHTNING_ABSORB_PERCENT, yellow},
		{STAT_MAGIC_ABOSRB_PERCENT, orange},
		{STAT_FIRE_ABSORB, red},
		{STAT_COLD_ABSORB, blue},
		{STAT_LIGHTNING_ABSORB, yellow},
		{STAT_MAGIC_ABSORB, orange},
		{STAT_MAGIC_FIND, white},
		{STAT_BLOCK_CHANCE, white},
		{STAT_FASTER_CAST_RATE, gold},
		{STAT_INCREASED_ATTACK_SPEED, gold},
		{STAT_FASTER_RUN_WALK, gold},
		{STAT_FASTER_HIT_RECOVER, gold},
		{STAT_EXPERIENCE_GAIN, white},
		{STAT_LIFE_REPLENISH, white},
		{STAT_OPEN_WOUNDS, white},
		{STAT_CRUSHING_BLOW, white},
		{STAT_DEADLY_STRIKE, white}
	};
